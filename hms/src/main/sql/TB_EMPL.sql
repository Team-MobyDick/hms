...
CREATE TABLE TB_EMPL (
    ...
    EMPL_DEPT    VARCHAR2(10) NOT NULL,
...
( 'ADMIN', '유영근', '01012345678', '관리자', '0', '', '', '일 잘하는 마스터', SYSDATE, 'ADMIN', SYSDATE, 'ADMNIN');

INSERT INTO TB_EMPL VALUES
( 'MIDDLE', '박현재', '01012345678', '팀장', '0', '', '', '일 잘하는 마스터', SYSDATE, 'ADMIN', SYSDATE, 'ADMNIN');

INSERT INTO TB_EMPL VALUES
( 'EMP01', '최영범', '01012345678', '팀원', '0', '', '', '화장실 청소 마스터', SYSDATE, 'ADMIN', SYSDATE, 'ADMNIN');